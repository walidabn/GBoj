...
public final class Bits {
    ...
    private final static int[] REVERSED_8 = new int[] {
    ...
    public static int mask(int index) {
        return 1 << checkIndex(index, Integer.SIZE);
    }
